  ...
  return (
    <aside className=" max-lg:hidden">
      {!authStatus ? (
        <div>
          <Card shadow="none" radius="sm" className="border">
            ...
            Research titans Community is a community of amazing developers
            </CardHeader>
            <CardBody>
      ...
      <Card shadow="none" className="pt-4">
        <CardHeader>
        Research titans blog A constructive and inclusive social network for software
        ...
        <CardFooter>Made with love and Nextjs.</CardFooter>
      </Card>
    </aside>
  );
};
